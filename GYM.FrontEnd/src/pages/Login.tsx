    ...
    <div className="login-bg min-vh-100 d-flex flex-column align-items-center justify-content-center p-3">
      ...
      <div className="login-card-container w-100" style={{ maxWidth: "420px" }}>
        <div className="login-card p-4 p-sm-5 rounded-4 border-neon-subtle shadow-neon-lg">
          {/* Header with GymQuest Aesthetic */}
          <div className="text-center mb-4">
            <h1
              className="fw-bold display-6 mb-1 cursor-pointer text-white"
              onClick={() => navigate("/")}
            >
          ...
          <form onSubmit={onSubmit} className="login-form">
              ...
              <div className="input-group">
                ...
                <button
                  ...
                  style={{
                    ...
                    borderColor: "var(--gq-surface-border)",
                  }}
            ...
            <div className="d-flex justify-content-between align-items-center mb-4">
              <div className="form-check custom-checkbox">
                ...
                />
                <label
                  className="form-check-label small text-gray cursor-pointer"
                  htmlFor="rememberMe"
                >
                  Remember me
                </label>
            ...
            {error && (
              <div
                className="alert alert-danger-quest p-2 mb-3 text-center small rounded-3 text-danger fw-semibold"
                role="alert"
              >
                ⚠️ {error}
              </div>
