...
export const api = axios.create({
  baseURL: import.meta.env.VITE_API_BASE_URL ?? 'https://gym-api-e8gkdgcxc6fqhufn.centralus-01.azurewebsites.net/api',
  headers: {
...
export const apiCall = axios.create({
  baseURL: import.meta.env.VITE_API_URL ?? 'https://gym-api-e8gkdgcxc6fqhufn.centralus-01.azurewebsites.net/api',
  headers: {
    'Content-Type': 'application/json',
  },
});
