...
import { FiCalendar, FiUser, FiX, FiLogOut, FiSettings, FiActivity, FiPlusCircle, FiUsers, 
        FiBookOpen, FiHome, FiInfo, FiStar, FiShield, } from "react-icons/fi";
...
export default function Navbar() {
    ...
    return (
        <>
          {/* HEADER PRINCIPAL */}
          <nav className="navbar navbar-dark gq-navbar px-4 py-3 z-3">
            <div className="container-fluid d-flex justify-content-between align-items-center">
              {/* Logo GymQuest */}
              <Link
                to={isAuthenticated ? "/home-user" : "/"}
                className="navbar-brand fw-bold fs-3 d-flex align-items-center gq-brand"
              >
              ...
              {!isAuthenticated ? (
                ...
                <div className="d-flex align-items-center gap-3 text-white fs-4">
                  ...
                  <div
                    className="gq-profile-avatar cursor-pointer"
                    onClick={toggleMenu}
                    title="Profile Menu"
                  >
          ...
          {/* MENÚ DESPLEGABLE DESDE LA DERECHA (Offcanvas Drawer) */}
          <div
          ...
          >
            ...
            <div className="d-flex justify-content-between align-items-center mb-3 pb-2 gq-drawer-header">
              <div>
                ...
                <small
                  className="gq-text-neon text-uppercase fw-semibold"
              ...
              <FiX
                className="text-white fs-3 cursor-pointer gq-nav-icon"
                onClick={toggleMenu}
              />
            </div>
            ...
            <div className="d-flex flex-column gap-1 mt-3">
              ...
              {/* --- RUTAS COMUNES / ATHLETE (Para todos los usuarios autenticados) --- */}
              ...
              <Link to="/user/mybookings" className="drawer-link" onClick={toggleMenu}>
              ...
              {/* --- PANEL DEDICADO A TRAINER (Solo visible si role === 'trainer') --- */}
              {role === "trainer" && (
                <>
                  <hr className="border-secondary my-2" />
                  <small className="gq-text-gold text-uppercase fw-bold px-2 mb-1">
                    Trainer Panel
                  </small>
              ...
              {/* --- PANEL DEDICADO A ADMIN (Solo visible si role === 'admin') --- */}
              {role === "admin" && (
                <>
                  <hr className="border-secondary my-2" />
                  <small className="text-danger text-uppercase fw-bold px-2 mb-1">
                    Admin Panel
                  </small>
                  ...
                  <Link
                    ...
                    onClick={toggleMenu}
                  >
                    <FiShield className="text-danger" /> Admin Dashboard
                  </Link>
                  ...
                  <Link
                    ...
                    onClick={toggleMenu}
                  >
                    <FiUsers className="text-danger" /> Staff & User Management
                  </Link>
                  ...
                  <Link
                    ...
                    onClick={toggleMenu}
                  >
                    <FiPlusCircle className="text-danger" /> Exercise Library
                  </Link>
                  ...
                  <Link
                    ...
                    onClick={toggleMenu}
                  >
                    <FiPlusCircle className="text-danger" /> Manage Trainings
                  </Link>
                </>
              )}
              ...
              <button
                className="btn btn-outline-danger d-flex align-items-center justify-content-center gap-2 p-2 w-100 rounded-pill mt-3 fw-semibold"
          ...
          {/* Fondo obscuro traslúcido al abrir el drawer */}
          {isOpen && <div className="gq-drawer-overlay" onClick={toggleMenu} />}
        </>
    );
}